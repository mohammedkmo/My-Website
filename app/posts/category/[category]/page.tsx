...
export default async function PostsCategoryPage({ params }: PageProps) {
  ...
  return (
    ...
    <div className="flex flex-col items-start justify-start">
      <h1 className={`text-6xl md:text-8xl font-bold ${dmSerifText.className} text-primary`}>{category}</h1>
      <p className="text-secondary">Here are some of my posts with the category {category}</p>
    </div>
